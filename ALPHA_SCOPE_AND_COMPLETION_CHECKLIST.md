...
| ---------------------------------- | ----------------------------------- | -------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Buyer — carrinho real no navegador | **PENDENTE DE IMPLEMENTAÇÃO ALPHA** | futura         | O cliente HTTP tipado do `CartsModule`, o estado/cache React Query, a adição real pela página pública do produto e `/carrinho` real com leitura, update e remoção estão concluídos. Ainda é preciso auditar e eliminar ou reconciliar dependências restantes de `CartProvider`/`cartService.ts` no caminho crítico, incluindo o badge global quando aplicável. |
