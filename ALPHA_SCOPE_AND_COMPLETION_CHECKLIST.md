...
| --------------------------------- | ----------------------------------- | -------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Buyer — pagamento Alpha           | **PENDENTE DE IMPLEMENTAÇÃO ALPHA** | futura         | O Order criado pelo checkout permanece inicialmente no fluxo de pagamento pendente. A próxima etapa ligará o navegador à orquestração fake/sandbox segura; `src/services/paymentService.ts` permanece mockado fora do checkout. Não é pagamento real. |
