...
| ---------------------------------- | ----------------------------------- | -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Buyer — carrinho real no navegador | **PENDENTE DE IMPLEMENTAÇÃO ALPHA** | futura         | A fundação tipada do cliente frontend do `CartsModule` está concluída em `src/services/cartApiService.ts`; conectar a experiência no navegador permanece pendente e `src/services/cartService.ts` continua mockado. |
