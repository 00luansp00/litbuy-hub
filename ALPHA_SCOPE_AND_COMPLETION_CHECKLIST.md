...
| --------------------------------- | ----------------------------------- | -------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Buyer — pagamento Alpha           | **CONCLUÍDO**                       | a atribuir após publicação | Browser Buyer ligado à API autenticada, orquestração persistida e `FAKE_ALPHA` não produtivo; evento provider-neutral confirma Payment e o worker existente ativa o Order. O mock frontend foi removido. Não é pagamento real. |
