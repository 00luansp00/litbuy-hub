...
| ---------------------------------- | ----------------------------------- | -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Buyer — carrinho real no navegador | **PENDENTE DE IMPLEMENTAÇÃO ALPHA** | futura         | O cliente HTTP tipado do `CartsModule` e sua camada de estado/cache React Query estão concluídos; conectar o produto e `/carrinho` à API real e remover `src/services/cartService.ts` do caminho crítico permanecem pendentes. |
