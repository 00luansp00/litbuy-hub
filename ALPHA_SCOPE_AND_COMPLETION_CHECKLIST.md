...
| ---------------------------------- | ----------------------------------- | -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Buyer — carrinho real no navegador | **PENDENTE DE IMPLEMENTAÇÃO ALPHA** | futura         | O cliente HTTP tipado do `CartsModule`, sua camada de estado/cache React Query e a adição real pela página pública do produto estão concluídos; conectar `/carrinho`, completar a experiência e remover `src/services/cartService.ts` do caminho crítico permanecem pendentes. |
