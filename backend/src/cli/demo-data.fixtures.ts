...
export const DEMO_IDS = {
  ...
  feeRuleBuyerVipBasic: uuid(8, 9),
  feeRuleBuyerVipPremium: uuid(8, 10),
...
export const DEMO_FEE_POLICY = {
  ...
  rules: [
    ...
    {
      id: DEMO_IDS.feeRuleBuyerVipBasic,
      code: 'demo-buyer-vip-basic',
    ...
    {
      id: DEMO_IDS.feeRuleBuyerVipPremium,
      code: 'demo-buyer-vip-premium',
      category: 'BUYER_SERVICE_FEE',
      partyCharged: 'BUYER',
      sellerPlan: null,
      promotionTier: null,
