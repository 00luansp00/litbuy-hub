...
CREATE UNIQUE INDEX "VerificationChallenge_active_step_up_scope_unique" ON "VerificationChallenge"("userId", "deviceId", "contextId") WHERE "purpose" = 'TWO_FACTOR_STEP_UP' AND "consumedAt" IS NULL;
