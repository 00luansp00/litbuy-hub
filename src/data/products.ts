...
export const products: Product[] = [
  ...
  // ==================================================
  // Sprint 18.8 — exemplos de produtos avançados (mockados).
  // Cobrem: Dinâmico (variantes), Serviço fixo, Serviço sob orçamento,
  // Moeda Virtual e Conta com accountInfo. Não quebram os produtos antigos.
  // ==================================================
  {
    id: "p33", slug: "conta-valorant-dinamica",
    title: "Contas Valorant — Escolha o nível",
    categorySlug: "contas", categoryName: "Contas",
    subcategorySlug: "valorant", subcategoryName: "Valorant",
    price: 89.9, fromPrice: 89.9,
    rating: 4.8, reviewsCount: 320, soldCount: 780,
    imageUrl: img("valorant-dinamica"),
    verifiedSeller: true, trustScore: 93,
    seller: sellers.nova, badge: "hot",
    stock: 30, status: "active",
    ...
    sellerPlan: "lit_max",
    attributes: [
      { key: "Servidor", value: "Brasil" },
      { key: "Rank", value: "Vários" },
    ],
    accountInfo: {
      ...
      fullAccess: true,
      recoveryRisk: "low",
      warrantyNote: "Garantia declarada de 15 dias após entrega.",
    },
    variants: [
      { id: "v-lvl5", title: "Conta level 5", description: "Ideal para começar.", price: 89.9, stock: 15, status: "active" },
      { id: "v-lvl8", title: "Conta level 8", description: "Alguns agentes desbloqueados.", price: 149.9, stock: 8, status: "active" },
      { id: "v-lvl15", title: "Conta level 15", description: "Ranqueada disponível + skins.", price: 249.9, stock: 5, status: "active" },
      { id: "v-lvl30", title: "Conta level 30 (esgotado)", price: 399.9, stock: 0, status: "active" },
    ],
  },
  {
    id: "p34", slug: "servico-boost-valorant-orcamento",
    title: "Boost personalizado Valorant — Sob orçamento",
    categorySlug: "servicos", categoryName: "Serviços",
    subcategorySlug: "boost", subcategoryName: "Boost",
    price: 0, fromPrice: 0,
    rating: 4.9, reviewsCount: 180, soldCount: 420,
    imageUrl: img("boost-orcamento"),
    verifiedSeller: true, trustScore: 95,
    seller: sellers.turbo,
    stock: 99, status: "active",
    ...
    attributes: [
      { key: "Modalidade", value: "Ranqueada" },
      { key: "Tempo médio", value: "3-7 dias" },
    ],
  },
  {
    id: "p35", slug: "moeda-lit-gold",
    title: "LIT Gold — Moeda virtual do jogo",
    categorySlug: "moedas", categoryName: "Moedas",
    subcategorySlug: "gold", subcategoryName: "Gold",
    price: 0.05, fromPrice: 5.0,
    rating: 4.8, reviewsCount: 520, soldCount: 3400,
    imageUrl: img("lit-gold"),
    instantDelivery: true, verifiedSeller: true, trustScore: 94,
    seller: sellers.arena,
    ...
    virtualCurrency: {
      ...
      minQuantity: 10000,
      step: 5000,
      availableStock: 5_000_000,
    },
  },
  {
    id: "p36", slug: "servico-coach-cs2-fixo",
    title: "Coach CS2 — Aula avulsa (preço fixo)",
    categorySlug: "servicos", categoryName: "Serviços",
    subcategorySlug: "coaching", subcategoryName: "Coaching",
    price: 79.9,
    rating: 4.9, reviewsCount: 90, soldCount: 240,
    imageUrl: img("coach-cs2-fixo"),
    verifiedSeller: true, trustScore: 92,
    seller: sellers.turbo, badge: "new",
    stock: 40, status: "active",
    listingModel: "service",
    productType: "service",
    ...
    deliveryMode: "manual",
    attributes: [
      { key: "Duração", value: "60 min" },
      { key: "Formato", value: "Discord" },
    ],
  },
];
