...
export function formStateToDraftPayload(form: ListingDraftFormState): DraftPayload {
  ...
  return {
    ...
    notifyBrowser: form.notifications.browser,
    notifyEmailFuture: form.notifications.emailFuture,
    notifyExternalFuture: form.notifications.externalIntegrationFuture,
