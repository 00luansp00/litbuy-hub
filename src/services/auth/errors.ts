...
const messages: Record<string, string> = {
  ...
  STEP_UP_REQUIRED: "Confirme sua identidade antes de continuar.",
  STEP_UP_NOT_AVAILABLE: "Confirmação adicional indisponível no momento.",
  STEP_UP_DELIVERY_UNAVAILABLE: "Entrega do código indisponível no momento.",
  INVALID_OR_EXPIRED_STEP_UP_CODE: "Código inválido, expirado ou já utilizado.",
  STEP_UP_CHALLENGE_LOCKED: "Muitas tentativas. Solicite um novo código.",
  INVALID_OR_EXPIRED_STEP_UP_GRANT: "Confirmação expirada. Repita a verificação.",
  STEP_UP_SCOPE_MISMATCH: "Confirmação inválida para esta operação.",
  TWO_FACTOR_METHOD_ALREADY_ACTIVE: "Este método de 2FA já está ativo.",
  TWO_FACTOR_METHOD_CHANGE_CONFLICT: "Não foi possível concluir a troca. Reinicie a verificação.",
