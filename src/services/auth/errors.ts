...
const messages: Record<string, string> = {
  ...
  TWO_FACTOR_CHALLENGE_CONFLICT: "Há outro desafio de 2FA em andamento.",
  TWO_FACTOR_METHOD_UNAVAILABLE: "Método de 2FA indisponível para esta conta.",
  TWO_FACTOR_NOT_ENABLED: "2FA não está ativado.",
  TWO_FACTOR_ALREADY_ENABLED: "2FA já está ativado.",
