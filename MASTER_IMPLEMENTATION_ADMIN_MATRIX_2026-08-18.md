...
| DISPUTE-POST-RELEASE-RECOVERY | Recovery após release | Recovery; Refund contract | NOT_PROVEN; boundaries documentais reconciliadas | pode gerar recovery/deficit decomposto; sem instant refund promise | Foundation persistente de decisão de principal existe; recovery/reservation/deficit/queue/payout continuam pendentes | recovery core | HUMAN_PROD_REVIEW | AA | 7 | NOT_IMPLEMENTED | HUMAN_PROD_REVIEW |
